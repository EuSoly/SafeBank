...
def realizar_login(arquivo):
    dados = carregar_dados(arquivo)  # Recarrega os dados antes de fazer o login
...
def fazer_deposito(arquivo, dados, cpf, modo_simulacao):
...
def fazer_saque(arquivo, dados, cpf, modo_simulacao):
...
def fazer_transferencia(arquivo, dados, cpf, modo_simulacao):
...
def main():
    ...
    while True:
        ...
        if opcao == '1':
            cpf, modo_simulacao = realizar_login(arquivo)
            if cpf:
                while True:
                    limpar_tela()
                    dados = carregar_dados(arquivo)  # Recarrega os dados antes de cada operação
                    ...
                    if escolha == '1':
                        fazer_deposito(arquivo, dados, cpf, modo_simulacao)
                        salvar_dados(arquivo, dados)  # Salvar saldo após depósito
                    elif escolha == '2':
                        fazer_saque(arquivo, dados, cpf, modo_simulacao)
                        salvar_dados(arquivo, dados)  # Salvar saldo após saque
                    elif escolha == '3':
                        fazer_transferencia(arquivo, dados, cpf, modo_simulacao)
            ...
            dados = carregar_dados(arquivo)  # Carrega dados antes de adicionar um usuário
